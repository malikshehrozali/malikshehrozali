        ...
        <div className="text-center h-[80vh] px-[10] w-full border-t-2 border-gray-500">
            ...
            <div className="flex items-center justify-center">
                <div className="border-t-2 border-gray-500 mt-10 mb-10 flex gap-5 items-center justify-center w-1/2">
                    <Link
                        href={"https://github.com/malikshehrozali"}
                        className="mt-10"
                    >
                        <FaGithub
                    ...
                    <Link
                        href={
                            "https://www.instagram.com/malikshehrozaliofficial/?hl=en"
                        }
                        className="mt-10"
                    >
                        <FaInstagram
                    ...
                    <Link
                        href={
                            "https://www.facebook.com/malikshehrozaliofficial"
                        }
                        className="mt-10"
                    >
                        <FaFacebook
                    ...
                    <Link
                        href={
                            "https://www.youtube.com/@malikshehrozaliofficial"
                        }
                        className="mt-10"
                    >
                        <FaYoutube
