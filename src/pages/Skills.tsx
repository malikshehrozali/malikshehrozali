            ...
            <div className="my-10 h-full w-full py-10 px-[10vw] ">
                <div className="relative w-[70vw] h-[80vh] p-10 flex flex-col lg:flex-row items-center justify-between bg-black border-2 border-primary-orange rounded-2xl z-10 shadow-lg shadow-primary-orange">
                    ...
                    <div className="flex-1 flex items-start flex-col gap-3 justify-center -mt-15 lg:mt-0">
                        ...
                        <p className="text-lg">
                            I’m a passionate Full Stack Developer and AI
                            Engineer dedicated to building intelligent,
                            scalable, and user-focused digital solutions. With a
                            deep understanding of both frontend and backend
                            technologies, I craft seamless applications that
                            blend performance, design, and functionality.
                        </p>
                        <p className="hidden xl:block text-lg">
                            My work spans from developing robust APIs and
                            cloud-native architectures to integrating machine
                            learning models that bring automation and
                            intelligence to products. I’m particularly skilled
                            in React, Next.js, Node.js, Python, and TensorFlow,
                            and I love turning complex challenges into clean,
                            efficient solutions.
                        </p>
                        <p className="hidden xl:block text-lg">
                            Beyond coding, I’m driven by curiosity — exploring
                            how AI and human creativity can work together to
                            redefine what technology can do. Whether I’m
                            optimizing systems or experimenting with new
                            frameworks, I approach every project with precision,
                ...
                <div className="relative w-[70vw] h-[80vh] bg-black border-2 border-primary-orange rounded-2xl p-10 flex flex-col lg:flex-row items-center justify-between z-5 -mt-[5vh] ml-[10vw] shadow-lg shadow-primary-orange">
                    <div className="flex-1 flex items-start flex-col gap-2 justify-center ">
                        <p className="text-lg text-primary-orange">Expertise</p>
                        <h2 className="md:text-5xl text-3xl font-bold relative">
                            Tech Stack
                        </h2>
                        <div className="grid md:grid-cols-2 xl:gap-8  text-gray-300">
                            <div>
                                <h3 className="text-xl font-semibold text-white border-b border-gray-700 md:pb-2 pb-1 md:mb-3">
                                    Frontend
                                </h3>
                            ...
                            <div>
                                ...
                                <p className="text-sm tracking-wide">
                                    Node.js · Express · Flask · Django · REST ·
                                    GraphQL
                                </p>
                            </div>
                            <div>
                                ...
                                <p className="text-sm tracking-wide">
                                    MongoDb · PostgreSQL · MySQL · MySQL ·
                                    FireBase
                                </p>
                            </div>
                            <div>
                                ...
                                <p className="text-sm tracking-wide">
                                    Python · TensorFlow · Pytorch · SciKit ·
                            ...
                            <div className="hidden xl:block">
                                ...
                                <p className="text-sm tracking-wide">
                                    Figma · Postman · VS Code · GitHub · Notion
                                    · Much More!
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="flex-1 -mt-20 lg:mt-0">
                        <p className="hidden md:block sm:block lg:text-[30vw] maskText2">
                            02
                        </p>
                    </div>
                </div>
                <div className="relative w-[70vw] h-[80vh]  p-10 flex flex-col lg:flex-row items-center justify-between bg-black border-2 border-primary-orange rounded-2xl -mt-[5vh] shadow-lg shadow-primary-orange">
                    <div className="flex-1 -mt-15 lg:mt-0">
                        <p className="text-[40vw] lg:text-[30vw] maskText">
                            03
                        </p>
                    </div>
                    <div className="flex-1 flex items-start flex-col gap-2 justify-center -mt-40 lg:mt-0">
                        <p className="text-lg text-primary-orange">
                            The Mindset
                        </p>
                        <h2 className="text-3xl lg:text-5xl font-bold relative">
                            I don’t just build products — I craft experiences
                            that think, adapt, and inspire.
                        </h2>
